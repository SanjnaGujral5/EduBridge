...
export const AppContextProvider = (props)=>{
    ...
    const [enrolledCourses, setEnoralledCourses] = useState([])
    ...
    // function to calclute avg rating of course
    ...
    // function to calclute course chapter time
    ...
    // function to calclute course duration 
    ...
    const fetchUserEnrolledCourses = async ()=>{
        setEnoralledCourses(dummyCourses)
    }
