...
const SearchBar = ({data}) => {
  ...
  return (
    ...
    border border-gray-500/20 rounded'>
      ...
      <input onChange={e => setInput(e.target.value)} value={input} type='text' placeholder='Search for courses' className='w-full
      h-full outline-none text-gray-500/80' />
      <button type='submit' className='bg-orange-600 rounded text-white md:px-10
