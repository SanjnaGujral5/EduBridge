...
const CourseDetails = () => {
  ...
  const fetchCourseData = async () => {
    ...
    console.log("courseData:", findCourse);
  };
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left"
      >
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p>
            Course by <span className="text-blue-600 underline">Techies</span>
          </p>
        ...
        {/* right column (FIXED — now outside the left column) */}
        <div
          className="max-w-course-card z-10 shadow-course-card rounded-t
          md:rounded-sm overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]"
        >
          {playerData ? (
            <Youtube
          ...
          <div className="p-5">
            ...
            <button
              className="md:mt-6 mt-4 w-full py-3 rounded bg-orange-600
            ...
            <div className="pt-6">
              <p className="md:text-xl text-lg font-medium text-gray-800">
                ...
                <ul className="ml-4 pt-2 text-sm md:text-default list-disc">
                  ...
                  <li>Quizzes to test your knoweledge</li>
