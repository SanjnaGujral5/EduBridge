      ...
      setChapters(
        chapters.map((chapter) => {
          if (chapter.chapterId === chapterId) {
            chapter.chapterContent.splice(lectureIndex, 1); // ✅ fixed typo here
          }
          return chapter;
        })
      );
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        <div className="flex items-center gap-6 mt-4">
          ...
          <div className="flex items-center gap-3 mt-4">
            <p className="whitespace-nowrap">Course Thumbnail</p>
            <label
            ...
            >
              <img
                ...
                alt="Upload icon"
                className="p-3 bg-blue-500 rounded w-10 h-10"
              />
              <input
                type="file"
                id="thumbnailImage"
            ...
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              <div className="flex justify-between items-center p-4 border-b">
                <div className="flex items-center">
                  <img
                    onClick={() => handleChapter('toggle', chapter.chapterId)} // ✅ fixed
                ...
                <img
                  onClick={() => handleChapter('remove', chapter.chapterId)} // ✅ fixed
            ...
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <img
                  ...
                  src={assets.cross_icon}
                  className="absolute top-4 w-4 cursor-pointer"
                  alt=" "
                />
              </div>
            </div>
